...
<body>
	...
	<div class="page-content" id="page-content">
		<fm:form class="form-horizontal" commandName="cgb_risk_case"
			action="recheck_list" method="POST">
					...
					<div class="widget-box">
						<div class="widget-header widget-header-flat">
							...
							<div class="widget-toolbar">
								<a href="#"
									onclick="do_tj('<c:url value="/risk_case/choose_save?bzw=3" />','确认审批通过?');">
									<i class="ace-icon fa fa-check green"></i> 审批通过
								</a> &nbsp; <a href="#"
									onclick="_submit('export?featurecodetype=3')"> <i
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="input-group col-xs-12 col-sm-8">
												...
												<button class="btn btn-info btn-mini" type="button"
													id="submitForm"
													onclick="_submit('recheck_list?isNewSearch=1')">
											...
											<tr class="text-center">
												<c:choose>
													<c:when test="${cases.status_cd=='2'}">
														...
														<td class="align-middle"><a class="green" href="#"
															onclick="do_back('<c:url value="/risk_case/back?caseid=${cases.caseid}&bzw=3"/>')"
															title="退回"><i
																class="ace-icon fa fa-arrow-circle-left red bigger-110"></i></a>
														</td>
													</c:when>
													<c:otherwise>
														<td>--</td>
												...
												<td class="align-middle" nowrap="nowrap"><a href="#"
													onclick="_tips(this,'${cases.casedesc}')">${cases.casedesc_disp}</a></td>
												...
												<td class="align-middle" nowrap="nowrap"><span
													class="label label-info arrowed-in arrowed-in-right">${cases.status_cd_disp}</span></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
	...
	<script type="text/javascript">
		...
		function do_tj(url, title) {
			var status_cd = $("#status_cd").val().trim();
			if (status_cd == '3') {
				agg.dialogAlert("数据已经审批通过！", "face-smile");
				return false;
			}
			var num = 0;
