	...
	<div class="page-content" id="page-content">
		<fm:form id="myform" commandName="cgb_face_data" class="form-horizontal"  method="POST"   >
			...
			<div class="widget-toolbar">
								<a href="#" onclick="do_tj('<c:url value="/cgb_face_data/remove_check_inner?bzw=Y" />','确定通过？')"> <i
									class="ace-icon glyphicon glyphicon-ok green"></i> 通过
								</a>&nbsp;&nbsp; <a href="#" onclick="do_tj('<c:url value="/cgb_face_data/remove_check_inner?bzw=N" />','确定不通过？')"> <i
                ...
                <div class="col-xs-12">
                                        <ul class="ace-thumbnails clearfix">
                                           <c:choose>
                                            <c:when test="${face_data.rm_flag == '1'}">
                                                <input type="hidden" name = "keys" value="${face_data.suspect_img_id}"/>
									...
									<ul class="ace-thumbnails clearfix">
                                         ...
                                         <a href="#" data-rel="colorbox">
                                                    ...
                                                    <c:if test="${data.rm_flag =='1'}">
                                                          <input type="hidden" name = "keys" value="${data.suspect_img_id}"/>
                                                    </c:if>
                                                    <div class="text">
													<div class="inner">
