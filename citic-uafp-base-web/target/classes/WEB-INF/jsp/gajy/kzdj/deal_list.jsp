										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<button class="btn btn-info btn-mini" type="button"
													onclick="_submit('deal_list?isNewSearch=1')">
										...
										<c:forEach var="kzqq_djList" items="${br41_kzqq_djList}">
											<tr class="text-center">
												<td nowrap="nowrap"><a href="#"
													onclick="_submit('<c:url value="/br41_kzqq_dj/kzdj_main?qqdbss=${kzqq_djList.qqdbs}&tasktypes=${kzqq_djList.tasktype}&rwlshs=${kzqq_djList.rwlsh}&zhs=${kzqq_djList.zh}&zhxhs=${kzqq_djList.zhxh}"/>')">
