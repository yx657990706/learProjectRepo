	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal" commandName="br41_kzqq_zf_back_mx"  action="zf_mx_list" method="POST">
					<!-- PAGE CONTENT BEGINS -->
					<fm:input type="hidden" path="tasktype"/>
					<fm:input type="hidden" path="qqdbs"/>
					<fm:input type="hidden" path="rwlsh"/>
					<fm:input type="hidden" path="zh"/>
					...
					<div class="widget-box">
						<div class="widget-header widget-header-flat">
					        ...
					        <a href="add?tasktype=${br41_kzqq_zf_back_mx.tasktype }&qqdbs=${br41_kzqq_zf_back_mx.qqdbs  }&rwlsh=${br41_kzqq_zf_back_mx.rwlsh }&zh=${br41_kzqq_zf_back_mx.zh }" >
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:select label="执行结果：" path="zxjg" items="${zxjgMap}"
													...
													onclick="_submit('zf_mx_list?isNewSearch=1')">
									...
									<tbody>
										...
										<c:forEach var="mxList" items="${br41_kzqq_zf_back_mxList}">
											<tr class="text-center">
												...
												<a href="#" onclick="testCancel(' ${mxList.rwlsh}/delete?rwlshs=${mxList.rwlsh}&tasktypes=${mxList.tasktype}&zhs=${mxList.zh}&zzhxhs=${mxList.zzhxh}&qqdbss=${mxList.qqdbs}')"> <i class="ace-icon fa fa-trash-o red" title="删除"></i></a>
												</td>
