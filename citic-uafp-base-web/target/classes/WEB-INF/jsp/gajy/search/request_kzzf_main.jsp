					...
					<fm:input type="hidden" path="tasktype"/>
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1"  onclick="_changeIframe('<c:url value="/br41_kzqq_zf/request_kzzt_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype}&qqcslx=${qqcslx }"/>','0901')" >
									<i class="green ace-icon fa fa-home bigger-120"></i>请求查询主体信息
								</a>
							</li>
								<li  id="li3">
								<a data-toggle="tab" href="#trans3"  onclick="_changeIframe('<c:url value="/br41_kzqq/request_kzzf_disp?qqdbs=${qqdbs}&tasktype=${tasktype}" />','0903')" >
							...
							<li id="li2">
								<a data-toggle="tab" href="#trans2"  onclick="_changeIframe('<c:url value="/br41_kzqq/hzws_list?qqdbs=${qqdbs }&rwlsh=${rwlsh}&tasktype=${tasktype}&isNewSearch=1"/>','0902')" >
							...
							<div class="widget-toolbar" style="line-height: 34px">
								...
								<a href="<c:url value="/br41_kzqq/response_kzzf_list?tasktype=${tasktype}"/>"	>
						...
						<div class="tab-content">
							<div id="trans1" class="tab-pane fade in active">
								<iframe src="<c:url value="/br41_kzqq_zf/request_kzzt_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype}&qqcslx=${qqcslx }"/>"  width="100%" height="500" scrolling="auto" frameborder="0"  id="0901"></iframe>
							</div>
