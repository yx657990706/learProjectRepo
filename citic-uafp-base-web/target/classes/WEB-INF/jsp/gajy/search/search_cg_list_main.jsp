...
<body>
	...
	<div class="page-content">
		<form  class="form-horizontal"  commandName="br40_cxqq"  action="request_cx_disp"  id="modifyfrozenbackform"  method="POST">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1" onclick="_changeIframe('<c:url value="/br40_cxqq_mx/search_cg_list?isNewSearch=1&qqdbs=${qqdbs}&qqcslxs=${qqcslx}"/>','0901')"> 
									<i class="green ace-icon fa fa-home bigger-120"></i>请求查询主体信息
								</a>
							</li>
							<%-- <li id="li2">
								<a data-toggle="tab"  href="#trans2"  onclick="_changeIframe('<c:url value="/br40_cxqq/request_cx_disp?qqdbs=${qqdbs}&type=${type}"/>','0902')" >
									<i class="green ace-icon fa fa-cloud orange bigger-120"></i>请求单信息
								</a>
							</li>  --%>
							<c:if test="${resource=='2' }">
							<div class="widget-toolbar" style="line-height: 34px">
							   <%-- <a href="#"  onclick="_OpenXLarge('<c:url value="/br40_cxqq/request_cx_disp?qqdbs=${qqdbs}&type=${type}"/>','请求单信息')">
								<i class="ace-icon fa fa-folder-open"></i> 请求单信息
								</a> --%>
								
								<button class="btn btn-info btn-sm" style="line-height: 20px"
									type="button"
									onclick="_OpenXLarge('<c:url value="/br40_cxqq/request_cx_disp?qqdbs=${qqdbs}&type=${type}"/>','请求单信息')">
									<i class="ace-icon fa fa-folder-open"></i> 请求信息
								</button>&nbsp; 
								<a href="<c:url value="/br40_cxqq/request_cx_list?type=${type }"/>">
						...
						<div class="tab-content">
							<div id="trans1" class="tab-pane fade in active">
								<iframe src="<c:url value="/br40_cxqq_mx/search_cg_list?isNewSearch=1&qqdbs=${qqdbs}&type=${type}&qqcslxs=${qqcslx}"/>"  width="100%" height="500"   id="0901"></iframe>
							</div>

							<!-- <div id="trans2" class="tab-pane fade">
								<iframe src="#" width="100%" height="500"   id="0902"></iframe>
							</div> -->
						    </div>
