...
<body>
	...
	<div class="page-content">
		<form  class="form-horizontal"  commandName="br40_cxqq"  action="request_disp"  id="m
		yform"  method="POST">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1"  onclick="_changeIframe('<c:url value="/br40_cxqq_mx/deal_dtjx_list?isNewSearch=1&qqdbs=${qqdbs }&rwlsh=${rwlsh}&tasktype=${tasktype}&qqcslx=${qqcslx }"/>','0901')" >
									<i class="green ace-icon fa fa-home bigger-120"></i>查询反馈
								</a>
							</li>
							<li id="li2">
								<a data-toggle="tab"  href="#trans2"  onclick="_changeIframe('<c:url value="/br40_cxqq_mx/deal_acct_trans_info?isNewSearch=1&qqdbs=${qqdbs }&qqcslx=${qqcslx}&rwlsh=${rwlsh}&tasktype=${tasktype}&qqcslx=${qqcslx }"/>','0902')">
