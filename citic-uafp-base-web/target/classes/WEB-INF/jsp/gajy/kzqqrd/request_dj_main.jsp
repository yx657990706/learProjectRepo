...
<body>
	...
	<div class="page-content">
		<form  class="form-horizontal"  commandName="br41_kzqq"  action="request_dj_disp"  id="modifyfrozenbackform"  method="POST">
				...
				<div class="col-sm-12">
					<div class="tabbable">
						<ul class="nav nav-tabs padding-16" id="myTab3">
							...
							<li id="li2">
								<a data-toggle="tab"  href="#trans2"  onclick="_changeIframe('<c:url value="/br41_kzqq_dj/dj_task_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype}&resource=2" />','0902')">
							...
							<div class="widget-toolbar" style="line-height: 34px">
								<a href="#"  onclick="_submit('<%=request.getContextPath() %>/br41_kzqq_dj/gajy_send_hx?qqdbs=${qqdbs}&tasktype=${tasktype}') "  >
                                		<i class="ace-icon glyphicon glyphicon-repeat orange"></i>提交
                                </a>&nbsp;&nbsp; 
								<a href="<c:url value="/br41_kzqq/request_dj_list?tasktype=${tasktype}"/>"	>
