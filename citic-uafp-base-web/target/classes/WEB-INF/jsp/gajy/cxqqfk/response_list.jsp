	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal" commandName="br40_cxqq" action="response_list" method="POST">
						...
						<div class="widget-body">
							<div class="widget-main">
						     ...
						     <div class="row">
									<div class="col-xs-12">
									   <div class="form-group col-xs-12 col-sm-6">
											<label class="control-label col-xs-12 col-sm-4 no-padding-right">反馈状态：</label>
												<div class="input-group col-xs-12 col-sm-8 ">
												<fm:select class=" input-medium" path="status" 	items="${statusMap}"/>
											</div>
										</div>
											<div class="form-group col-xs-12 col-sm-6">
											<label
								...
								<div class="widget-main no-padding">
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											...
											<c:forEach var="br40_cxqq" items="${br40_cxqqList}">
												<tr class="text-center">
												  <td>
				                                        <a href="#" onclick="_submit('<c:url value="/br40_cxqq/response_main?qqdbss=${br40_cxqq.qqdbs}&qqcslxs=${br40_cxqq.qqcslx}" />')">
				                                            <i class="ace-icon glyphicon glyphicon-search green" title="查看"></i>
				                                        </a>
				            
                                   				 </td>
											 	<td nowrap>${br40_cxqq.qqdbs}</td>
												<td nowrap>${br40_cxqq.scount}</td> 
												<td nowrap>${br40_cxqq.ucount}</td> 
												<td nowrap>${br40_cxqq.fcount}</td> 
							                    <td nowrap>${br40_cxqq.qqcslx_disp}</td>
							                  <%--   <td nowrap>${br40_cxqq.ztlb_disp}</td>   --%>
							                    <td nowrap>${br40_cxqq.status_disp}</td>
							                    <c:if test="${br40_cxqq.hzdm=='99999' }">
							                    <td nowrap>${br40_cxqq.hzsm}</td>
							                    </c:if>
							                       <c:if test="${br40_cxqq.hzdm!='99999' }">
							                    <td nowrap>${br40_cxqq.hzdm_disp}</td>
							                    </c:if>
							                    <td nowrap>${br40_cxqq.qrydt}</td>
							                    <td nowrap>${br40_cxqq.ajlx_disp}</td>
							                    <td nowrap>${br40_cxqq.jjcd_disp}</td>
							                    <td nowrap>${br40_cxqq.fssj}</td>
							                    <td nowrap>${br40_cxqq.sqjgdm_disp}</td>
												<td nowrap>${br40_cxqq.mbjgdm_disp}</td>	
												</tr>
											</c:forEach>
										</tbody>
									</table>
