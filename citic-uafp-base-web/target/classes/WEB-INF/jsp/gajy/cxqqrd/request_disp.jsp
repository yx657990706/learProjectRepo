...
<body>
	<div class="page-content">
		<fm:form class="form-horizontal" commandName="br40_cxqq" action="request_disp" method="POST">
				...
				<div class="col-sm-12">
									...
									<div class="widget-main no-padding">
										...
										<div class="agg_GridDetail">
											<table>
												...
												<!-- 判断如果是深圳公安 -->
												<c:if test="${br40_cxqq.tasktype=='8'}">
													<tr>
														<td>请求人办公电话：</td>
														<td>${br40_cxqq.qqrbgdh}</td>
														<td>协查人手机号：</td>
														<td>${br40_cxqq.xcrsjh}</td>
													</tr>
													<tr>
														<td>协查人办公电话：</td>
														<td>${br40_cxqq.xcrbgdh}</td>
													</tr>
												</c:if>
							...
							<div class="Ar_other">
								...
								<c:forEach items="${br40_wh_attachList}" var="attachList">
		                                &nbsp; &nbsp; &nbsp; &nbsp;<span> <a href='#'
										onclick="_download('${attachList.filepath}','${attachList.wjmc}')">
											<!-- 判断如果是深圳，文件名称后面需要加文件类型后缀 -->
											<c:choose>
											<c:when test="${attachList.tasktype=='8'}">
											${attachList.wjmc}.${attachList.wjlx}
											</c:when>
											<c:otherwise>
											${attachList.wjmc}
											</c:otherwise>
											</c:choose>
										<i class="ace-icon fa fa-file-pdf-o bigger-110 light-red"></i>&nbsp;&nbsp;
									</a></span>
									<br />
								</c:forEach>
