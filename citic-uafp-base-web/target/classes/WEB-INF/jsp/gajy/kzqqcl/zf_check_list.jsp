									...
									<tbody>
										...
										<c:forEach var="kzqq_zfList"  items="${br41_kzqq_zfList}" >
											...
											<!-- 	<td nowrap="nowrap">
												 ...
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br41_kzqq_zf/zffk_check_main?qqdbss=${kzqq_zfList.qqdbs}&tasktypes=${kzqq_zfList.tasktype}&rwlshs=${kzqq_zfList.rwlsh}&zhs=${kzqq_zfList.zh}&qqcslxs=${kzqq_zfList.qqcslx}"/>')">
