					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1"  onclick="_changeIframe('<c:url value="/br40_cxqq_mx/deal_yxpz_disp?qqdbs=${qqdbs }&qqcslx=${qqcslx}&rwlsh=${rwlsh}"/>','0901')" >
									<i class="green ace-icon fa fa-home bigger-120"></i>反馈基本数据项
								</a>
							</li>
							<li id="li2">
								<a data-toggle="tab"  href="#trans2"  onclick="_changeIframe('<c:url value="/br40_cxqq_mx/deal_yxpz_list?isNewSearch=1&qqdbs=${qqdbs }&qqcslx=${qqcslx}&rwlsh=${rwlsh}"/>','0902')">
						...
						<div class="tab-content">
							<div id="trans1" class="tab-pane fade in active">
								<iframe src="<c:url value="/br40_cxqq_mx/deal_yxpz_disp?qqdbs=${qqdbs }&qqcslx=${qqcslx}&rwlsh=${rwlsh}"/>"  width="100%" height="500" scrolling="auto" frameborder="0"  id="0901"></iframe>
							</div>

							<div id="trans2" class="tab-pane fade">
								<iframe src="<c:url value="/br40_cxqq_mx/deal_yxpz_list?isNewSearch=1&qqdbs=${qqdbs }&qqcslx=${qqcslx}&rwlsh=${rwlsh}"/>" width="100%" height="500" scrolling="auto" frameborder="0"  id="0902"></iframe>
							</div>
						    </div>
					</div>
				</div>
