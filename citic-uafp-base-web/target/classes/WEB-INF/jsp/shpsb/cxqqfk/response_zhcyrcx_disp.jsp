				...
				<div class="space-8"></div>
					<div class="agg_GridDetail">
						<table>
						    <tr>
                      	        <td>报文批次号：</td>
                      	        <td> ${br54_cxqq_back_card.msgseq }</td>
                      	        <td>请求单号：</td>
                      	         <td> ${br54_cxqq_back_card.bdhm }</td>
                      	     </tr>
						<tr>
                      	        <td>持卡人姓名：</td>
                      	        <td> ${br54_cxqq_back_card.ckrxm }</td>
                      	        <td>证照类型：</td>
                      	        <td>${br54_cxqq_back_card.zzlx_disp }</td>
                      	     </tr>
                      	     <tr>
                      	        <td>证照号码：</td>
                      	        <td> ${br54_cxqq_back_card.zzhm }</td>
                      	        <td>查询日期：</td>
                      	         <td>${br54_cxqq_back_card.qrydt }</td>
                      	     </tr>
					</table>
					</div>
			</div><!-- /.widget-main -->
