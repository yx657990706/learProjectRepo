    ...
    <div class="widget-header widget-header-flat">
        <h5 class="widget-title lighter">
            <span class="glyphicon glyphicon-play-circle orange" ></span>
             查询账户信息<!--前面的图标可加可不加，这种表格就是widget-box-->
        </h5>
        ...
        <div class="widget-main">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group col-xs-12 col-sm-6">
                            <label class="control-label col-xs-12 col-sm-4 no-padding-right" >客户类型：</label>
                            <div class="col-xs-12 col-sm-8 no-padding-left">
                                <fm:select path="party_class_cd" class=" input-medium" items="${party_class_cdMap }"/>
                                  &nbsp;
