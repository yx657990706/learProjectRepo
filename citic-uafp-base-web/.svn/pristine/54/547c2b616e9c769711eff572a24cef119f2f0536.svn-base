...
<body>
  <div class="page-content">
  		<form  class="form-horizontal"  commandName="br41_kzqq"  action="zffk_check_main"  id="form"  method="POST">
      ...
      <div class="row">
			<div class="col-sm-12">
				<div class="tabbable">
						...
						<a data-toggle="tab" href="#trans1" onclick="_changeIframe('<c:url value="/br41_kzqq_zf_back/kzzf_fk_disp?qqdbs=${br41_kzqq.qqdbs }&tasktype=${br41_kzqq.tasktype }&rwlsh=${br41_kzqq.rwlsh }" />','0901')">
						<i  class=" ace-icon fa fa-users red bigger-120"></i>反馈止付结果信息</a>
						</li>
							<!--判断如果是公安  添加反馈明细信息  -->
							<c:if test="${br41_kzqq.tasktype=='3'}">
						<li id="li2">
								<a data-toggle="tab"  href="#trans2"  onclick="_changeIframe('<c:url value="/br41_kzqq_zf_back/zf_bzck_mx_list?isNewSearch=1&qqdbs=${br41_kzqq.qqdbs}&rwlsh=${br41_kzqq.rwlsh}&tasktype=${br41_kzqq.tasktype}&zh=${br41_kzqq.zh}"/>','0902')" >
				...
				<div class="widget-toolbar" style="line-height: 34px">
						<button class="btn btn-info btn-sm" style="height: 33px" type="button"
								...
								<a href="#"    onclick="_submit('gajy_zfcheck_send_jg?qqdbs=${br41_kzqq.qqdbs }&rwlsh=${br41_kzqq.rwlsh }&tasktype=${br41_kzqq.tasktype}&qqcslx=${br41_kzqq.qqcslx}') "  >
		                                <i class="ace-icon glyphicon glyphicon-repeat orange"></i>
		                                发送监管机构
		                        </a>&nbsp;&nbsp;
		                        
		                         <%--    <a href="#"  onclick="_submit('gajy_zfcheck_returnBack?qqdbs=${br41_kzqq.qqdbs }&rwlsh=${br41_kzqq.rwlsh }&tasktype=${br41_kzqq.tasktype}') "  > --%>
                                	<a href="#"  onClick="_OpenMid('br41_kzqq_zf/gajy_zfcheck_returnBack?qqdbs=${br41_kzqq.qqdbs }&rwlsh=${br41_kzqq.rwlsh }&tasktype=${br41_kzqq.tasktype}','退回')">
									
                                	  <i class="ace-icon glyphicon glyphicon-repeat orange"></i>退回                               
                                </a>&nbsp;&nbsp;
                              
                        	
						<a href="<c:url value="/br41_kzqq_zf/deal_check_list?isNewSearch=1&tasktype=${br41_kzqq.tasktype }" />">
				...
				<div class="tab-content">
					<div id="trans1" class="tab-pane fade in active">
						<iframe src="<c:url value="/br41_kzqq_zf_back/kzzf_fk_disp?qqdbs=${br41_kzqq.qqdbs }&tasktype=${br41_kzqq.tasktype }&rwlsh=${br41_kzqq.rwlsh }" />" width="100%" height="500" scrolling="auto" frameborder="0"  id="0901"></iframe>
					</div>
							<!--判断如果是公安  添加反馈明细信息  -->
							<c:if test="${br41_kzqq.tasktype=='3'}">
