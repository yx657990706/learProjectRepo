...
<div class="page-content">
	<fm:form class="form-horizontal" commandName="br54_cxqq_"  action="save_data"  method="POST" id="myform">
            <!-- 隐藏域 -->
					...
					<div class="agg_GridDetail">
						...
						<tr>
                      	     ...
                      	     <tr>
                      	        ...
                      	        <td>承办人2：</td>
                      	        <td>${br54_cxqq_mx.cbr2 }</td>
                      	     </tr>
                      	     <tr>
                      	        <td>证照类型：</td>
                      	        <td>${br54_cxqq_mx.zzlx_disp}</td>
                      	        <td>证照号码：</td>
                      	        <td> ${br54_cxqq_mx.zzhm }</td>
                      	     </tr>
								<tr>
                      	        <td>涉案对象名称：</td>
