										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
										     <fm:select label="紧急程度：" class=" input-medium" path="jjcd"
													items="${jjcdMap}" />
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('request_list?isNewSearch=1')">
									...
									<tbody>
										...
										<c:forEach var="cxqqList"  items="${br40_cxqqList}" >
											<tr class="text-center">
												 ...
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br40_cxqq/request_main?qqdbss=${cxqqList.qqdbs}&qqcslxs=${cxqqList.qqcslx}&tasktypes=${cxqqList.tasktype}" />')">
