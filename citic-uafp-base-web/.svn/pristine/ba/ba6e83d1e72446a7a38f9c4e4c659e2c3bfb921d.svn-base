	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal"  commandName="br41_kzqq_dj_back_mx"  action="dj_mx_list"  method="POST">
					...
					<input type="hidden" id="url">
						<div class="widget-header widget-header-flat">
							...
							<div class="widget-toolbar">
							  <a href="add?tasktype=${br41_kzqq_dj_back_mx.tasktype }&qqdbs=${br41_kzqq_dj_back_mx.qqdbs  }&rwlsh=${br41_kzqq_dj_back_mx.rwlsh }&zh=${br41_kzqq_dj_back_mx.zh }&zzhxh=${br41_kzqq_dj_back_mx.zzhxh }" >
						...
						<div class="widget-body">
							<div class="widget-main">
									...
									<div class="form-group col-xs-12 col-sm-6">
											<label
												class="control-label col-xs-12 col-sm-4 no-padding-right">冻结开始时间：</label>
											<div class="input-group col-xs-12 col-sm-8 ">
												<fm:input class="form-control date-picker"
													path="djkssj_start" type="text"
													data-date-format="yyyy-mm-dd" />
												<span class="input-group-addon"> <i
													class="fa fa-arrows-h"></i>
												</span>
												<fm:input class="form-control date-picker" path="djkssj_end"
									...
									<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="input-group col-xs-12 col-sm-8 ">
												<fm:input class="form-control date-picker"
													path="djjssj_start" type="text"
													data-date-format="yyyy-mm-dd" />
												<span class="input-group-addon"> <i
													class="fa fa-arrows-h"></i>
												</span>
												<fm:input class="form-control date-picker" path="djjssj_end"
													type="text" data-date-format="yyyy-mm-dd" />
												<span class="input-group-addon"> <i
													class="fa fa-calendar bigger-110"></i>
												</span>
										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
										     <fm:select label="执行结果：" class="input-medium" path="zxjg" items="${zxjgMap }" />
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('dj_mx_list?isNewSearch=1')">
									...
									<tbody>
										<c:forEach var="mxList"  items="${br41_kzqq_dj_back_mxList}" >
											<tr class="text-center">
												  <td nowrap="nowrap">
												<a href="modify?rwlsh=${mxList.rwlsh}&tasktype=${mxList.tasktype}&zh=${mxList.zh}&zzhxh=${mxList.zzhxh}&qqdbs=${mxList.qqdbs}" ><i class="ace-icon fa fa-pencil green" title="编辑"></i></a>&nbsp;
												<a href="#" onclick="testCancel(' delete?rwlshs=${mxList.rwlsh}&tasktypes=${mxList.tasktype}&zhs=${mxList.zh}&zzhxhs=${mxList.zzhxh}&qqdbss=${mxList.qqdbs}')"> <i class="ace-icon fa fa-trash-o red" title="删除"></i></a>
												</td>
