									...
									<tbody>
										...
										<c:forEach var="cxqqList"  items="${br40_cxqqList}" >
											...
											<!-- 	<td nowrap="nowrap">
												 ...
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br40_cxqq/cxqq_deal_main?qqdbss=${cxqqList.qqdbs}&rwlshs=${cxqqList.rwlsh}&qqcslxs=${cxqqList.qqcslx}&tasktypes=${cxqqList.tasktype}&cxnr=${cxqqList.cxnr}&resource=2"/>')">
