...
<body>
	<fm:form class="form-horizontal" commandName="br41_kzqq"
		action="request_kzzf_disp" method="POST">
					...
					<div class=" widget-color-blue agg_widgetbox">
						...
						<div class="Ar_other">
							...
							<c:forEach items="${br40_wh_attachList }" var="attachList">
                                ...
                                &nbsp; &nbsp; &nbsp; &nbsp;<span><i
									class="ace-icon fa fa-file-pdf-o bigger-110 light-red"></i>&nbsp;&nbsp;
									<a href='#'
									onclick="_download('${attachList.filepath}','${attachList.wjmc}')">
										${attachList.wjmc }</a></span>
								<br />
							</c:forEach>
