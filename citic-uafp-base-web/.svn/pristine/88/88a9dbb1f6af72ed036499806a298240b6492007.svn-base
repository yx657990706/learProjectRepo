									...
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:select label="请求措施类型：" path="qqcslx"
													items="${qqcslxMap}" class=" input-medium" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="input-group  col-xs-12 col-sm-8  ">
												...
												<button class="btn btn-info btn-mini" type="button"
													onclick="_submit('request_zf_list?isNewSearch=1&tasktype=${br41_kzqq.tasktype}')">
										...
										<c:forEach var="kzqqList" items="${br41_kzqqList}">
											<tr class="text-center">
												<td nowrap="nowrap"><a href="#"
													onclick="_submit('<c:url value="/br41_kzqq/request_zf_main?qqdbss=${kzqqList.qqdbs}&tasktypes=${kzqqList.tasktype}&resource=2" />')">
