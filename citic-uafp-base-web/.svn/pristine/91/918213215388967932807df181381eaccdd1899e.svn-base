	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal"  commandName="br41_kzqq"  action="request_zf_list" method="POST">
										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
										     <fm:select label="紧急程度：" class=" input-medium" path="jjcd"
												...
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('request_zf_list?isNewSearch=1&tasktype=${searchObj.tasktype}&type=${type}')">
									...
									<tbody>
										...
										<c:forEach var="kzqqList"  items="${br41_kzqqList}" >
											...
											<!-- 	<td nowrap="nowrap">
												 ...
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br41_kzqq_dj/request_dj_main?qqdbss=${kzqqList.qqdbs}&tasktypes=${kzqqList.tasktype}&resource=2&type=${type}" />')">
