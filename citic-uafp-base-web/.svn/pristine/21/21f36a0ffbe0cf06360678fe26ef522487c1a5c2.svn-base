	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal"  commandName="br41_kzqq"  action="request_kzdj_list" method="POST">
									...
									<div class="col-xs-12">
									 <div class="form-group col-xs-12 col-sm-6">
										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('request_kzdj_list?isNewSearch=1')">
									...
									<tbody>
										...
										<c:forEach var="kzqqList"  items="${br41_kzqqList}" >
											<tr class="text-center">
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br41_kzqq/request_tjfx_main?qqdbs=${kzqqList.qqdbs}&qqcslx=${kzqqList.qqcslx }&resource=2&isdync=2&tasktype=${kzqqList.tasktype}" />')">
