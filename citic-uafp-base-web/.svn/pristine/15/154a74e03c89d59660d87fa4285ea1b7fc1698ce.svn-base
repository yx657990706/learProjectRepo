...
<body>
	<div id="page-content" class="page-content">
		<fm:form class="form-horizontal" commandName="br41_kzqq_zf_back_mx" id="myForm" action="save_add" method="POST">
			...
			<div class="widget-box transparent">
				<div class="widget-header widget-header-flat">
					<h4 class="widget-title">
						<i class="ace-icon fa fa-star orange"></i> 添加止付明细信息
					</h4>
				...
				<div class="widget-body">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="form-group col-xs-12 col-sm-6">
									<label
										class="control-label col-xs-12 col-sm-4 no-padding-right">账户：</label>
									<div class="col-xs-12 col-sm-8 input-group">
										<fm:input type="text" class="input-large" path="zh"	require="true" 	datatype="require" />
									</div>
								</div>
					
											<div class="form-group col-xs-12 col-sm-6">
									<label
										class="control-label col-xs-12 col-sm-4 no-padding-right">子账号序号：</label>
									<div class="col-xs-12 col-sm-8 input-group">
										<fm:input path="zzhxh" class="input-large" require="true" 	datatype="require" />
									</div>
								</div>
							</div>
						</div>
										...
										require="true" datatype="require" msg="请输入" />
												  ...
												  <div class="form-group col-xs-12 col-sm-6">
													...
													<div class="input-group col-xs-12 col-sm-6">					
                                                    	<fm:input class="form-control datetimepicker"   path="zfkssj"  data-date-format="yyyy-mm-dd" />
									...
									<fm:select path="bz" class="input-medium" items="${bzMap }"
										require="true" datatype="require|english" />
										  ...
										  <div class="form-group col-xs-12 col-sm-6">
													...
													<div class="input-group col-xs-12 col-sm-6">					
                                                    	<fm:input class="form-control datetimepicker"   path="zfjssj"  data-date-format="yyyy-mm-dd" />
                                                   <span class="input-group-addon">
                                                 <i class="fa fa-calendar bigger-110"></i>
                                                   </span>										
													</div>
					...
					<div class=" form-actions text-center">
						<button class="btn btn-info btn-sm" type="button"
							onclick="vSubmit('<c:url value="/br41_kzqq_zf_back/save_add"/>','myForm')">
		...
		function vSubmit(url, formname) {
		 ...
		 if(result=="0"){   //成功
			...
			//	var zhzzh=$("#zhzzh").val();
				...
				var zh=$("#zh").val();
			    	if(reason==""||zh==""||zzhxh==""){
			    		agg.dialogAlert("失败原因、子账户序号不能为空","face-smile");
			    		return false;
			    	}
					document.forms[0].action = url;
					document.forms[0].submit();
