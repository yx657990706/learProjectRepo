...
<fm:form class="form-horizontal" commandName="br40_city_no"   id="myForm"   action="save_modify"  method="POST">
	<rm:token />
	...
	<div class="widget-box transparent">
		<div class="widget-header widget-header-flat">
			...
			<div class="widget-toolbar">
					<a href="<c:url value="/br40_city_no/list"/>">
			...
			<div class="widget-main no-padding">
		      ...
		      <div class="row">
				 ...
				 <div class="row">
					<div class="col-xs-12">
							...
							<div class="col-xs-12 col-sm-8">
                               ...
                               <fm:select  class="input-large"  path="flag"   items="${flagMap }" require="true" datatype="require" />
							</div>
						</div>
					</div>
				</div>
				...
				<div class=" form-actions text-center">
					<button class="btn btn-info btn-sm" type="button"  onclick="vSubmit('<c:url value="/br40_city_no/save_modify"/>','myForm')">
