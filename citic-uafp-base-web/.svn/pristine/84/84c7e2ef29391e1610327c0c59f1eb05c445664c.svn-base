										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
										     <fm:select label="紧急程度：" class=" input-medium" path="jjcd"
													items="${jjcdMap}" />
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('search_proof_list?isNewSearch=1')">
									...
									<tbody>
										...
										<c:forEach var="cxqqList"  items="${br40_cxqq_back_pzList}" >
											<tr class="text-center">
                                    	        <td  nowrap="nowrap"><a href="#" onclick="_OpenXLarge('<c:url value="/br40_cxqq/proof_modify_disp?tasktype=${cxqqList.tasktype}&qqdbs=${cxqqList.qqdbs}&rwlsh=${cxqqList.rwlsh}"/>','凭证图像信息')">${cxqqList.rwlsh}</a> </td>
