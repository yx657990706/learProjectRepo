...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<fm:form class="form-horizontal" commandName="br40_cxqq_back_trans"
					action="deal_acct_dt_trans_list" method="POST">
					<fm:hidden path="qqcslx" />
					<fm:hidden path="qqdbs" />
					<fm:hidden path="rwlsh" />
					<fm:hidden path="tasktype" />
					<fm:hidden path="seq" />
					<fm:hidden path="status" />
					<fm:hidden path="backurl" />
					<div class="widget-box">
						<div class="widget-header widget-header-flat">
							...
							<div class="widget-toolbar">
								<c:if test="${br40_cxqq_back_trans.status!='2'}">
									<a href="#"
										onclick="_submit('<%=request.getContextPath()%>/br40_cxqq/gajy_send?flag=2') ">
										<i class="ace-icon glyphicon glyphicon-repeat orange"></i>提交
									</a>&nbsp;&nbsp;
                               </c:if>
								<a href="#" onclick="_submit('${br40_cxqq_back_trans.backurl}')">
							...
							<div class="widget-main">
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											<label
												class="control-label col-xs-12 col-sm-4 no-padding-right">查询账卡号：</label>
										...
										<div class="form-group col-xs-12 col-sm-6">
											<label
												class="control-label col-xs-12 col-sm-4 no-padding-right">交易时间：</label>
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input class="form-control date-picker" path="jysj_start"
													type="text" data-date-format="yyyy-mm-dd" />
												<span class="input-group-addon"> <i
													class="fa fa-arrows-h"></i>
												</span>
												<fm:input class="form-control date-picker" path="jysj_end"
													type="text" data-date-format="yyyy-mm-dd" />
												<span class="input-group-addon"> <i
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											<label
												class="control-label col-xs-12 col-sm-4 no-padding-right">查询账户：</label>
											<div class="col-xs-12 col-sm-8 input-group">
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<button class="btn btn-info btn-mini" type="button"
													id="submitForm"
													onclick="_submit('deal_acct_dt_trans_list?isNewSearch=1')">
										...
										<c:forEach var="infolist" items="${br40_cxqq_back_transList}">
											<tr class="text-center">
                                              ...
                                              <a href="#"> <i class="ace-icon fa fa-trash-o red" title="删除"></i>
												...
												<td nowrap="nowrap">${infolist.jywddm    }</td>
