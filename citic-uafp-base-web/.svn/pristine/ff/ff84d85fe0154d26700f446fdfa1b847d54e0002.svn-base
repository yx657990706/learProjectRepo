...
<div id="page-content" class="page-content">
	<fm:form class="form-horizontal" commandName="br41_kzqq_dj_back_mx" id="myForm" action="save_add" method="POST">
		...
		<div class="widget-box transparent">
			<div class="widget-header widget-header-flat">
				<h4 class="widget-title">
					<i class="ace-icon fa fa-star orange"></i> 添加冻结明细信息
				</h4>

				<div class="widget-toolbar">
					<a href="#" onclick="_submit('dj_mx_list')"> <i
				...
				<div class="widget-main no-padding">
				    ...
				    <div class="row">
						<div class="col-xs-12">
								...
								<label class="control-label col-xs-12 col-sm-4 no-padding-right">账户：</label>
							<div class=" input-group col-xs-12 col-sm-8">
									<fm:input type="text" class="input-large" path="zh"	require="true" datatype="require" />
											...
											<div class="form-group col-xs-12 col-sm-6">
								<label class="control-label col-xs-12 col-sm-4 no-padding-right">子账户序号：</label>
								<div class=" input-group col-xs-12 col-sm-8">
									<fm:input type="text" class="input-large" path="zzhxh" require="true" datatype="require" />
								</div>
							</div>
					...
					<div class=" form-actions text-center">
						<button class="btn btn-info btn-sm" type="button"
							onclick="vSubmit('<c:url value="/br41_kzqq_dj_back/save_add"/>','myForm')">
