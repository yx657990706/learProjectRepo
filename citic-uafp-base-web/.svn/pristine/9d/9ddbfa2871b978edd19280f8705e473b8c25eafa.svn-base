...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<fm:form class="form-horizontal" commandName="br40_cxqq_back" action="deal_dtjx_list" method="POST">
				<fm:hidden path="qqdbs"/>
				<fm:hidden path="tasktype"/>
				<fm:hidden path="rwlsh"/>
				<fm:hidden path="qqcslx"/>
				<fm:hidden path="backurl"  value="deal_dtjx_list"/>
						...
						<div class="widget-header widget-header-flat">
                            ...
                            <a href="#" onclick="_submit('response_mx_list')"	>
							                   ...
							                   <div class="form-group col-xs-12 col-sm-6">
												...
												<span class="input-group-addon"> <i
													...
													<div class="input-group col-xs-12 col-sm-8">
														...
														<button class="btn btn-info btn-mini" type="button" id="submitForm" onclick="_submit('deal_dtjx_list?isNewSearch=1')" >
										...
										<thead class="thin-border-bottom">
											  <tr>
							                    ...
							                    <th nowrap="nowrap">卡号</th>
							                     <th nowrap="nowrap">核心反馈状态</th>
							                    <th nowrap="nowrap">核心反馈结果</th>
										      ...
										      <th nowrap="nowrap">执行时间区间</th>
												...
												<c:if test="${br40_cxqq_back.qqcslx=='02' && br40_cxqq_back.tasktype=='8' }">
										...
										<tbody>
											<c:forEach var="backList" items="${br40_cxqq_backList}">
											 ...
											 <td nowrap>${backList.rwlsh}</td> 
											 	...
											 	<c:otherwise>
											 		<a href="#"  onclick="_submit('deal_acct_dt_trans_list?isNewSearch=1&seq=${backList.seq}&status=2')">
											 	${backList.seq}
											 	</a>
											 	</c:otherwise>
											 	</c:choose>
												...
												<td nowrap>
												<c:if test="${backList.cxfkjg=='0'}">成功</c:if>
												<c:if test="${backList.cxfkjg=='1'}">失败</c:if>
												</td> 
