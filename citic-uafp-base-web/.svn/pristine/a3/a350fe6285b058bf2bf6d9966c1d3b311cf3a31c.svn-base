	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal" commandName="br41_kzqq_zf"
					action="request_zt_list" method="POST">
									...
									<tbody>
										<c:forEach var="kzqq_zfList" items="${br41_kzqq_zfList}">
											<tr class="text-center">
												<td nowrap="nowrap">
												<%-- <a href="#"
													onclick="_OpenXLarge('<c:url value="/br41_kzqq_zf_back/kzzf_fk_disp?qqdbs=${kzqq_zfList.qqdbs}&rwlsh=${kzqq_zfList.rwlsh}&tasktype=${kzqq_zfList.tasktype}"/>','止付反馈信息')">
														${kzqq_zfList.rwlsh}</a> --%>
														${kzqq_zfList.rwlsh}</td>
												...
												<%-- <td nowrap="nowrap"> ${kzqq_zfList.msgcheckresult_disp} </td> --%>
