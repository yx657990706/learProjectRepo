...
<div class="widget-box">
    <div class="widget-header widget-header-flat">
        <h5 class="widget-title lighter">
           ...
           <c:if test="${br54_cxqq_mx.qrymode=='dwczrzcx' }">单位操作日志查询</c:if>
            <c:if test="${br54_cxqq_mx.qrymode=='grczrzcx' }">个人操作日志查询</c:if>
        </h5>
        ...
        <div class="widget-main no-padding">
            <table class="table table-striped table-bordered table-hover"  id="gs">
                ...
                <tr class="text-center">
                    ...
                    <td nowrap>${mxList.tjlb_disp }</td>
                     <td nowrap>${mxList.zh }</td>
                     <td nowrap>${mxList.jylsh }</td>
                    <td nowrap>${mxList.cxkssj }</td>
                    <td nowrap>${mxList.cxjssj }</td>
                </tr>
                </c:forEach>
