...
<body>
	<div class="page-content"  id="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<fm:form id="myform"  class="form-horizontal" commandName="cgb_face_data" 	action="check_list" method="POST">
				<input type="hidden"  id="url"  name="url" />
				<input type="hidden" id="re_url" name="re_url"
						value="<c:url value="/cgb_face_data/check_list?isNewSearch=1"/>" />
				<div class="widget-box">
						<div class="widget-header widget-header-flat">
							...
							<div class="widget-toolbar">
								<a href="#" onclick="do_tj('<c:url value="/cgb_face_data/check_do_outer?identify_result=0" />','确定不通过')"> <i
									class="ace-icon glyphicon glyphicon-remove red"></i> 不通过
								</a>&nbsp;&nbsp; <a href="#" onclick="do_tj('<c:url value="/cgb_face_data/check_do_outer?identify_result=2" />','确定灰名单')"> <i
									class="ace-icon fa fa-plus-circle grey"></i> 灰名单
								</a>&nbsp;&nbsp; <a href="#" onclick="do_tj('<c:url value="/cgb_face_data/check_do_outer?identify_result=1" />','确定黑名单')"> <i
									...
									<div class="form-group col-xs-12 col-sm-6">
										...
										<fm:select path="md_channel" class=" input-medium"
											...
											<button class="btn btn-info btn-mini" type="button"
												id="submitForm" onclick="vSubmit('check_list?isNewSearch=1','myform')">
								...
								<c:forEach items="${cgb_face_dataList}" var="checkList">
									<tr class="text-center">
										<td class="align-middle" nowrap>
											<div class="checkbox">
												<label><input type="checkbox" class="ace" name="gID" value="${checkList.group_id}&${checkList.data_source}"/><span
													class="lbl"></span>
												</label>
											</div>
										</td>
										<td class="align-middle" nowrap><a href="#"
											onclick="to_open('<c:url value="/cgb_face_data/group_query_list?group_id=${checkList.group_id}&bzw=1" />','查看本组信息')">
