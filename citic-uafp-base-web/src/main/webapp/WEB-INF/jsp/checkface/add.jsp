...
<body>
	<div class="page-content" id="page-content">
		<fm:form id="myform" commandName="cgb_face_data"
			class="form-horizontal" action="add" method="POST"
					...
					<div class="widget-box transparent">
						<div class="widget-header widget-header-flat">
							<h4 class="widget-title">
								<i class="ace-icon fa fa-star orange"></i> 添加名单
							</h4>
									...
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											<label
												...
												<span style="color: red">*</span>嫌疑人图像上传：
											</label>
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="file_suspect_path" type="file"
													class=" input-large" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
												class="control-label col-xs-12 col-sm-4 no-padding-right">
												<span style="color: red">*</span>联网核查图像上传：
											</label>
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="file_victim_path" type="file"
													class=" input-large" />
											</div>
										</div>
									</div>
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="victim_name" class=" input-large"
													require="true" datatype="require" type="text"
													maxlength="32" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
												...
												被冒用人证件类型：</label>
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:select path="victim_card_type" class=" input-medium"
													items="${victim_card_typeMap }" require="true"
													datatype="require" />
											</div>
										</div>
									</div>
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input type="text" path="victim_card_num"
													class=" input-large" require="true"
													datatype="require|safeString|idCard" maxlength="18" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:select path="risk_type" class=" input-medium"
													items="${risk_typeMap }" require="true" datatype="require" />
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<div class=" input-group col-xs-12 col-sm-10">
													...
													<fm:hidden path="busi_website" require="true"
														datatype="require|numLen" maxlength="6" para="办理网点" />
												</div>
											</div>
										</div>
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="input-group  col-xs-12 col-sm-8 ">
												<fm:input type="text" class=" input-medium"
													path="victim_card_validity" require="true"
													datatype="require|date_8" maxlength="8" />
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											<label
												...
												业务办理柜员号：</label>
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="busi_teller_num" class=" input-medium"
													type="text" require="true" datatype="require|numLen"
													maxlength="8" para="柜员号" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
												...
												业务办理时间：</label>
											<div class="input-group  col-xs-12 col-sm-8 ">
												<fm:input type="text" class="input-medium" path="busi_time"
													require="true" datatype="require|date_8" maxlength="8" />
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="address" class=" input-large" type="text"
													maxlength="64" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6"
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:select path="busi_way" class=" input-medium"
													items="${busi_wayMap}" />
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="col-xs-12">
										<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="telephone" class=" input-large"
													require="true" datatype="mobile" type="text" maxlength="11" />
											</div>
										</div>
										<div class="form-group col-xs-12 col-sm-6">
											<label
											...
											<div class="col-xs-12 col-sm-8 input-group">
												<fm:input path="busi_type" class="input-medium" type="text"
													require="true" datatype="numLen" maxlength="6"
													para="业务办理类型" />
											</div>
										</div>
									</div>
	...
	<script
		src="<c:url value='/resources/js/cgb/cgb.jquery.validator.js' />"></script>
	<script
	...
	<script type="text/javascript">
		...
		function vSubmit(url, formname) {
			...
			if (jQuery(iframe).isValid()) {
				//文件
				if ($('#file_suspect_path').val() == null
						|| $('#file_suspect_path').val() == "") {
					agg.dialogAlert("请上传嫌疑人图像", "face-smile");
					return false;
				} else {//图片格式校验
					var suPath = $('#file_suspect_path').val();
					var index = suPath.lastIndexOf(".");
					if (index != -1) {
						var suff = suPath.substring(index + 1).toLowerCase();
						if (suff != "png" && suff != "jpg") {
							agg.dialogAlert("请上传正确的嫌疑人图像，格式为png或者jpg",
									"face-smile");
							return false;
						}
					}
				}
				if ($('#file_victim_path').val() == null
						|| $('#file_victim_path').val() == "") {
					agg.dialogAlert("请上传联网核查图像", "face-smile");
					return false;
				} else {
					var suPath = $('#file_victim_path').val();
					var index = suPath.lastIndexOf(".");
					if (index != -1) {
						var suff = suPath.substring(index + 1).toLowerCase();
						if (suff != "png" && suff != "jpg") {
							agg.dialogAlert("请上传正确的联网核查图像，格式为png或者jpg",
									"face-smile");
							return false;
						}
					}
