...
<body>
	...
	<div class="page-content">
		<form  class="form-horizontal"  commandName="br40_cxqq"  action="request_cx_disp"  method="POST">
					...
					<div class="tabbable">
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1" onclick="_changeIframe('<c:url value="/br40_cxqq_mx/search_cg_list?isNewSearch=1&qqdbs=${qqdbs}&qqcslx=${qqcslx}&tasktype=${tasktype }"/>','0901')"> 
							...
							<div class="widget-toolbar" style="line-height: 34px">
								<button class="btn btn-info btn-sm" style="line-height: 20px"
									type="button"
									onclick="_OpenXLarge('<c:url value="/br40_cxqq/request_cx_disp?qqdbs=${qqdbs}&tasktype=${tasktype }"/>','请求单信息')">
									<i class="ace-icon fa fa-folder-open"></i> 请求单信息
								</button>&nbsp; 
								<a href="<c:url value="/br40_cxqq/request_cg_list?tasktype=${tasktype }"/>">
						...
						<div class="tab-content">
							<div id="trans1" class="tab-pane fade in active">
								<iframe src="<c:url value="/br40_cxqq_mx/search_cg_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype }&qqcslx=${qqcslx}"/>"  width="100%" height="500"   id="0901"></iframe>
							</div>
						    </div>
