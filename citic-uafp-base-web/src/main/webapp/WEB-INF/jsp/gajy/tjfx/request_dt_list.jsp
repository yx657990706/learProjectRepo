	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal"  commandName="br40_cxqq"  action="request_dt_list" method="POST">
									 ...
									 <div class="form-group col-xs-12 col-sm-6">
										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
												...
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('request_dt_list?isNewSearch=1')">
									...
									<tbody>
										...
										<c:forEach var="cxqqList"  items="${br40_cxqqList}" >
											<tr class="text-center">
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br40_cxqq/request_cx_main?qqdbss=${cxqqList.qqdbs}&qqcslxs=${cxqqList.qqcslx}&tasktypes=${br40_cxqq.tasktype }&resource=2" />')">
