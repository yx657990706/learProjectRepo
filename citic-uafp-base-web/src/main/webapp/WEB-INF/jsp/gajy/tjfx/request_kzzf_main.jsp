					...
					<fm:input type="hidden" path="tasktype"/>
						<ul class="nav nav-tabs padding-16" id="myTab3">
							<li class="active" id="li1">
								<a data-toggle="tab" href="#trans1"  onclick="_changeIframe('<c:url value="/br41_kzqq_zf/request_kzzt_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype}&rwlsh=${rwlsh}&qqcslx=${qqcslx }"/>','0901')" >
							...
							<div class="widget-toolbar" style="line-height: 34px">
									...
									type="button"
									onclick="_OpenXLarge('<c:url value="/br41_kzqq/request_kzzf_disp?qqdbs=${qqdbs}&tasktype=${tasktype}&rwlsh=${rwlsh }&qqcslx=${qqcslx }" />','请求信息')">
									<i class="ace-icon fa fa-folder-open"></i> 请求信息
								</button>&nbsp; 
								<a href="<c:url value="/br41_kzqq/request_kzzf_list?&tasktype=${tasktype}"/>"	>
						...
						<div class="tab-content">
							<div id="trans1" class="tab-pane fade in active">
								<iframe src="<c:url value="/br41_kzqq_zf/request_kzzt_list?isNewSearch=1&qqdbs=${qqdbs}&tasktype=${tasktype}&rwlsh=${rwlsh}&qqcslx=${qqcslx }"/>"  width="100%" height="500" scrolling="auto" frameborder="0"  id="0901"></iframe>
							</div>
						    </div>
					</div>
				</div>
