...
<div class="page-content">
	...
	<fm:form class="form-horizontal" commandName="br40_cxqq_hzws"   id="myForm">
	...
	<div class="widget-box transparent">
		<div class="widget-header widget-header-flat">
			...
			<div class="widget-toolbar">
				<a href="#"  onclick="_submit('hzws_list?tasktype=${br40_cxqq_hzws.tasktype}&rwlsh=${br40_cxqq_hzws.rwlsh}&qqdbs=${br40_cxqq_hzws.qqdbs}')">
