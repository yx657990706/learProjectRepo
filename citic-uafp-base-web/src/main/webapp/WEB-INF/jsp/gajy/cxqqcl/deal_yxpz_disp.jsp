...
<fm:form class="form-horizontal" commandName="br40_cxqq_back" action="deal_yxpz_save"  method="POST" id="myform">
            <!-- 隐藏域 -->
        <div class="row">
            <div class="col-xs-12">
                               ...
                               <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group col-xs-12 col-sm-12 ">
                                        <label class="control-label col-xs-2 col-sm-2 no-padding-right">查询主体类别：</label>
									    <div class=" col-xs-12 col-sm-8 ">
