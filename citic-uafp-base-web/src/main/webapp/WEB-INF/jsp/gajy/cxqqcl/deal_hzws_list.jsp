...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<fm:form class="form-horizontal"  commandName="br40_cxqq_hzws"  action="hzws_list"  method="POST">
							...
							<div class="widget-main">
								<table class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<c:forEach var="hzws"  items="${br40_cxqq_hzwsList}" >
											<tr class="text-center">
											
												<td nowrap>
											    <a  href="<c:url value="hzws_modify?wskey=${hzws.wskey}&qqdbs=${hzws.qqdbs}&tasktype=${hzws.tasktype}"/>"  title="编辑" > <i class="ace-icon fa fa-pencil  green" > </i>  </a> 
														  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;		
								                  <c:if test="${hzws.wjpath!=''}">
												 <a href='#' onclick="_download('${hzws.wjpath}','${hzws.wjmc}.${hzws.wjlx}')"> 
