...
<body>
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<fm:form class="form-horizontal" commandName="br41_kzqq" action="response_kzdj_list" method="POST">
									...
									<div class="col-xs-12">
										...
										<label class="control-label col-xs-12 col-sm-4 no-padding-right">发送时间：</label>
											<div class="input-group col-xs-12 col-sm-8 ">
												<fm:input class="form-control datetimepicker"    path="fssj_start"  data-date-format="yyyy-mm-dd" />
                                                   <span class="input-group-addon">
                                                  <i class="fa fa-arrows-h"></i>
                                                    </span>
                                                    	<fm:input class="form-control datetimepicker"   path="fssj_end"  data-date-format="yyyy-mm-dd" />				
                                                   <span class="input-group-addon">
									...
									<div class="col-xs-12">
										...
										<div class="form-group col-xs-12 col-sm-6">
											...
											<button class="btn btn-info btn-mini" type="button"
												onclick="_submit('response_kzdj_list?isNewSearch=1') ">
							...
							<div class="widget-body">
								<div class="widget-main no-padding">
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>
											<c:forEach var="br41_cxqq" items="${br41_kzqqList}">
												<tr class="text-center">
												  <td>
				                             <a href="#" onclick="_submit('<c:url value="/br41_kzqq/request_kz_main?qqdbs=${br41_cxqq.qqdbs}&qqcslx=${br41_cxqq.qqcslx}&isdync=2" />')">
                                                         <i class="ace-icon glyphicon glyphicon-search green" title="查看"></i>
                                                        </a>
                                   				 </td>
											 	<td nowrap>${br41_cxqq.qqdbs}</td>
												<td nowrap>${br41_cxqq.scount}</td> 
												<td nowrap>${br41_cxqq.ucount}</td> 
												<td nowrap>${br41_cxqq.fcount}</td> 
							                    <td nowrap>${br41_cxqq.qqcslx_disp}</td>
							                   <%--  <td nowrap>${br41_cxqq.ztlb_disp}</td>   --%>
							                    <td nowrap>${br41_cxqq.status_disp}</td>
							                    <td nowrap>
							                    <c:if test="${br41_cxqq.hzdm=='99999' }">
							                    ${br41_cxqq.hzsm}
							                    </c:if>
							                    <c:if test="${br41_cxqq.hzdm!='99999' }">
							                    ${br41_cxqq.hzdm_disp}
							                    ...
							                    <td nowrap>${br41_cxqq.qrydt}</td>
							                    <td nowrap>${br41_cxqq.ajlx_disp}</td>
							                    <td nowrap>${br41_cxqq.jjcd_disp}</td>
							                    <td nowrap>${br41_cxqq.fssj}</td>
							                    <td nowrap>${br41_cxqq.sqjgdm_disp}</td>
												<td nowrap>${br41_cxqq.mbjgdm_disp}</td>	
												</tr>
											</c:forEach>
										</tbody>
									</table>
