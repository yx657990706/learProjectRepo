	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<fm:form class="form-horizontal"  commandName="br41_kzqq"  action="request_kzzf_list" method="POST">
							...
							<div class="widget-main">
								 <div class="row">
									...
									<div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
										        ...
										        <fm:input  path="type"  class="input-large" type="hidden" />
										        <fm:input  path="qqcslx"  class="input-large" type="hidden" />
											</div>
									<%--  <div class="form-group col-xs-12 col-sm-6">
											<label
								...
								<%-- 	<div class="form-group col-xs-12 col-sm-6">
										 ...
										 <div class="form-group col-xs-12 col-sm-6">
											...
											<div class="col-xs-12 col-sm-8 input-group">
											 <fm:select label="状态："  path="status"  items="${statusMap}"  class=" input-medium"/>
											</div>
										</div>
										...
										<div class="form-group col-xs-12 col-sm-6">
										    ...
										    <div class="input-group  col-xs-12 col-sm-8  ">
										     <fm:select label="紧急程度：" class=" input-medium" path="jjcd"
													items="${jjcdMap}" />
												<button class="btn btn-info btn-mini" type="button"  onclick="_submit('request_kzzf_list?isNewSearch=1&qqcslx=${searchObj.qqcslx}&type=${type}')">
									...
									<tbody>
										...
										<c:forEach var="kzqqList"  items="${br41_kzqqList}" >
											...
											<!-- 	<td nowrap="nowrap">
												 ...
												 <td  nowrap="nowrap">
                                                    <a href="#" onclick="_submit('<c:url value="/br41_kzqq/request_kzzf_main?qqdbss=${kzqqList.qqdbs}&resource=2&type=${type}" />')">
									        	...
									        	<td nowrap="nowrap"> ${kzqqList.status_disp} </td>
