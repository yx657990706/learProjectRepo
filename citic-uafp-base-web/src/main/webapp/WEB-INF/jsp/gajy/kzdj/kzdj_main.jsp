...
<body>
  <div class="page-content">
  	<fm:form  class="form-horizontal"  commandName="br41_kzqq"  action="kzdj_main"  id="form"  method="POST">
      <div class="row">
			<div class="col-sm-12">
				<div class="tabbable">
					 <ul class="nav nav-tabs padding-16" id="myTab">				 
						<li class="active" id="li1"> 
						<a data-toggle="tab" href="#trans1" onclick="_changeIframe('<c:url value="/br41_kzqq_dj/kzdj_disp?qqdbs=${br41_kzqq.qqdbs }&tasktype=${br41_kzqq.tasktype }&rwlsh=${br41_kzqq.rwlsh }" />','0901')">
						...
						<!-- 判断是公安 查询反馈明细信息 -->
							...
							<li id="li2"><a data-toggle="tab" href="#trans2"
								onclick="_changeIframe('<c:url value="/br41_kzqq_dj_back/dj_mx_list?isNewSearch=1&qqdbs=${br41_kzqq.qqdbs }&tasktype=${br41_kzqq.tasktype }&rwlsh=${br41_kzqq.rwlsh }&zh=${br41_kzqq.zh}&zzhxh=${br41_kzqq.zhxh}"/>','0902')">
						...
						<a href="#"  onclick="_submit('<%=request.getContextPath() %>/br41_kzqq_dj/gajy_send_jg?qqdbs=${br41_kzqq.qqdbs }&rwlsh=${br41_kzqq.rwlsh }&tasktype=${br41_kzqq.tasktype}') "  >
						...
						<a href="<c:url value="/br41_kzqq_dj/deal_list?isNewSearch=1&tasktype=${br41_kzqq.tasktype }" />">
				...
				<div class="tab-content">
					<div id="trans1" class="tab-pane fade in active">
						<iframe src="<c:url value="/br41_kzqq_dj/kzdj_disp?qqdbs=${br41_kzqq.qqdbs }&tasktype=${br41_kzqq.tasktype }&rwlsh=${br41_kzqq.rwlsh }" />" width="100%" height="500" scrolling="auto" frameborder="0"  id="0901"></iframe>
					</div>
						<!-- 判断是公安 查询反馈明细信息 -->
						<c:if test="${br41_kzqq.tasktype=='3' }">
