...
<div class="widget-box">
    <div class="widget-header widget-header-flat">
        <h5 class="widget-title lighter">
           ...
           <c:if test="${br54_cxqq_mx.qrymode=='dwkhzlcx' }">单位开户资料查询</c:if>
            <c:if test="${br54_cxqq_mx.qrymode=='grkhzlcx' }">个人开户资料查询</c:if>
        </h5>
        ...
        <div class="widget-main">
             <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group col-xs-12 col-sm-6">
                            <label class="control-label col-xs-12 col-sm-4 no-padding-right" >涉案对象名称：</label>
                            <div class="input-group col-xs-12 col-sm-8">
                                <fm:input type="text" path="mc" class="input-large" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group col-xs-12 col-sm-6">
                            ...
                            <div class="input-group col-xs-12 col-sm-8">
                             <fm:input type="text" path="zzhm" class="input-large" />
                              
                            </div>
                        </div>
                        <div class="form-group col-xs-12 col-sm-6">
                            <label class="control-label col-xs-12 col-sm-4 no-padding-right" >证照类型：</label>
                            <div class="input-group col-xs-12 col-sm-8">
                                  <fm:select  path="zzlx"  class=" input-medium"  items="${zzlxMap}" />
        ...
        <div class="widget-main no-padding">
            <table class="table table-striped table-bordered table-hover"  id="gs">
                ...
                <tr class="text-center">
                    ...
                    <td nowrap>${mxList.zzlx_disp }</td>
                     <td nowrap>${mxList.zzhm }</td>
                     <td nowrap>${mxList.mc }</td>
                </tr>
                </c:forEach>
