									...
									<tbody>
										<c:forEach var="cxqqList" items="${br54_cxqqList}">
											<tr class="text-center">
												<td nowrap><a href="request_mx_list?isNewSearch=1&party_class_cd=${cxqqList.party_class_cd}&qrymode=${cxqqList.qrymode}&msgseq=${cxqqList.msgseq }">${cxqqList.msgseq }</a></td>
												...
												<td nowrap>${cxqqList.yhdm_disp }</td>
												<td nowrap>${cxqqList.recipient_p }</td> 
												<td nowrap>${cxqqList.recipient_time }</td>
											    <td nowrap>${cxqqList.feedback_P }</td>
